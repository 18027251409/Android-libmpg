...
JNIEXPORT jint JNICALL Java_nobleworks_libmpg_MP3Decoder_seek
  (JNIEnv *env, jobject instance, jlong handle, jlong sampleOffset)
{
    Mp3File *mp3 = (Mp3File *)handle;
    return mpg123_seek(mp3->handle, sampleOffset, SEEK_SET);
}

JNIEXPORT jlong JNICALL Java_nobleworks_libmpg_MP3Decoder_position
  (JNIEnv *env, jobject instance, jlong handle)
{
    Mp3File *mp3 = (Mp3File *)handle;
...
JNIEXPORT jlong JNICALL Java_nobleworks_libmpg_MP3Decoder_getLength(JNIEnv *env, jobject instance, jlong handle)
{
    Mp3File *mp3 = (Mp3File *)handle;
    return mp3->length;
}
